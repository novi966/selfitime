    ...
    <section class="py-10 mt-10">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM bookings ORDER BY tanggal DESC";
                $bookings = mysqli_query($koneksi, $sql);
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $booking['background'] ?></td>
                        <td><?= $booking['jumlah_orang'] ?></td>
                        <td><?= $booking['jumlah_pembayaran'] ?></td>
